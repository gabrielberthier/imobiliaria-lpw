...
import edu.ifma.lpweb.imobiliaria.service.CidadeService;
...
public class CidadeController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Cidade> buscaPor(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    @CacheEvict( value = "listaDeCidades", allEntries = true)
    public ResponseEntity<Cidade> atualiza(@PathVariable Long id,
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Cidade> atualizacaoParcial(@PathVariable Long id,
